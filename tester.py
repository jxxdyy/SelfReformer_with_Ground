...
class Tester():
    ...
    def evaluate(self, path):
        ...
        if opt.save_result:
            ...
            matt_save_root = os.path.join(save_root, "matt")
            img_save_root = os.path.join(save_root, "sal")
            os.makedirs(save_root, exist_ok=True)
            os.makedirs(matt_save_root, exist_ok=True)
        ...
        for i, inputs in enumerate(tqdm(self.test_loader)):
            ...
            if opt.save_result:
                ...
                save_path_matt = os.path.join(matt_save_root, "{}_matt.png".format(NAME))
                ...
                if opt.save_all:
                    ...
                    # save pred image
                    save_path_sal = os.path.join(img_save_root, "{}.png".format(NAME))
